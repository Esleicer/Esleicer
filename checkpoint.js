...
Array.prototype.encontraIndex = function (valor, desde = 0) {
   ...
   constructor(nombre, salario, tareas, jefe = false) {
    ...
    addTarea(tarea, prioridad) {
      ...
      // no debe retornar nada.
        this.tareas =  ["comprar" ,{"prioridad": 1, "tarea": "comprar"}];
    ...
    getTareas() {
      ...
      // Ej:
      // persona.getTareas() 
      // retorna ['compras', 'dar clases', 'operaciones']
    this.tares = i;
    let tareas;
 i = [["compras", "dar clases", "operaciones"],""];

       return i.find(el => tareas==tareas);
         }
